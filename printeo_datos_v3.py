...
app.layout = html.Div(html.Div([html.H4('Ejemplo', style={'textAlign' : 'center'}), html.Div(id='live-update-text'), dcc.Graph(id='live-update-graph'), dcc.Graph(id='live-update-graph2'),
